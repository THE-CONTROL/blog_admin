...
export default {
    ...
    setup( props ) {
        ...
        function getPostDetails() {
            fetch(`https://osamamwen.pythonanywhere.com/admin/posts/${props.contentId}`, {
                method: "GET",
                headers: {
        ...
        function getComments(page) {
            fetch( `https://osamamwen.pythonanywhere.com/admin/post/comments/${postDetails.value.id}`, {
                method: "GET",
                headers: {
                    "Content-Type":"application/json",
                    Authorization: `Bearer ${localStorage.getItem('admin-access')}`,
        ...
        return { comments, getPostDetails, postDetails, getComments,
        route, router, deleteComment, meta, user }
    }
}
</script>
